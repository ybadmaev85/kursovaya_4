    ...
    def get_formatted_vacancies(self):
        ...
        for vacancy in self.vacancies:
            ...
            if salary:
                ...
                formatted_vacancies["currency_value"] = currencies[salary["currency"]] if salary["currency"] in currencies
            else:
            ...
            formatted_vacancies.append(formatted_vacancies)
    ...
    def get_formatted_vacancies(self):
        ...
        for vacancy in self.vacancies:
            ...
            if vacancy["currency"] in sj_currencies:
                ...
                formatted_vacancy["currency_value"] = currencies[sj_currencies[vacancy["currency"]]] if sj_currencies[vacancy["currency"]]
